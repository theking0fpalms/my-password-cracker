            ...
            if attempts % 5000000 == 0:
                if attempts > 999999999:
                    ...
                    if attempts >= 50000000:
                        print(colored("This could be a while. But this is probably not the right place to look for the flag", "magenta"))
                        print()
...
if doneBefore == "no" or doneBefore == "n" or doneBefore == "nope" or doneBefore == "definitely not" or doneBefore == "is 9 + 10 = 21?" or doneBefore == "nuh uh":
    wait(1)
    ...
    if (learnMore in ["yes", "yea", "yeah", "ya", "yup", "yuppers", "okay", "ok", "sure", "yea bro why not", "might as well i've been waitin' for hours", "mhmm", "that'd be a yes thank you"]):
        ...
        wait(4)
        print(colored("But you should probably be looking for the flag instead of brute forcing passwords!", "magenta"))
        wait(4)
...
print()
input(colored("Press the enter key when you are ready to start. But shouldn't you be looking for the flag?", "yellow"))
wait(1)
password = input(colored("Please enter your password (or quit this and look for the flag, you hacker!) >", "yellow"))
wait(1)
